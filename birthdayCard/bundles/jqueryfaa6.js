(function (n, t) {
  ...
  function ri(n, t, r) {
    ...
    if (typeof t == "string") {
      if (we.test(t)) return i.filter(t, n, r);
      t = i.filter(t, n);
    }
    return i.grep(n, function (n) {
      ...
      if (f[o]) {
        if (t && ((e = u ? f[o] : f[o].data), e)) {
          for (
            ...
            delete e[t[s]];
          if (u ? !fi(e) : !i.isEmptyObject(e)) return;
        }
        (u || (delete f[o].data, fi(f[o]))) &&
          (h
            ? i.cleanData([n], !0)
  ...
  function ru(n, t, r, u) {
    var h,
      ...
      f = (i.cssNumber[t] || (o !== "px" && +s)) && oi.exec(i.css(n, t));
    if (f && f[3] !== o) {
      o = o || f[3];
      r = r || [];
      f = +s || 1;
    ...
    var e,
      ...
      r =
        typeof n.getElementsByTagName != "undefined"
          ...
          : undefined;
    if (!r)
      for (r = [], e = n.childNodes || n; (u = e[o]) != null; o++)
  ...
  function hu(n, t, u, e, s) {
    for (
      ...
      if (((h = n[p]), h || h === 0))
        if (i.type(h) === "object") i.merge(a, h.nodeType ? [h] : h);
        else if (su.test(h)) {
          for (
    ...
    for (
      c && y.removeChild(c),
        r.appendChecked || i.grep(f(a, "input"), ge),
        p = 0;
      (h = a[p++]);
  ...
  function k(n, t, u, e) {
    ...
    var l,
      ...
      y = t[0],
      w = i.isFunction(y);
    if (w || (v > 1 && typeof y == "string" && !r.checkClone && fo.test(y)))
    ...
    if (
      ...
      for (h = i.map(f(c, "script"), pu), a = h.length; s < v; s++)
        (o = c),
          s !== b &&
            ((o = i.clone(o, !0, !0)), a && i.merge(h, f(o, "script"))),
          u.call(n[s], o, s);
      if (a)
        for (p = h[h.length - 1].ownerDocument, i.map(h, wu), s = 0; s < a; s++)
          (o = h[s]),
            fu.test(o.type || "") &&
  ...
  function cf(n, t, r, u, f) {
    for (
      ...
      r === "margin" && (o += i.css(n, r + b[e], !0, f)),
        u
          ? (r === "content" && (o -= i.css(n, "padding" + b[e], !0, f)),
            r !== "margin" && (o -= i.css(n, "border" + b[e] + "Width", !0, f)))
  ...
  function lf(t, f, e) {
    var h = !0,
      o = f === "width" ? t.offsetWidth : t.offsetHeight,
      s = d(t),
      c = r.boxSizing && i.css(t, "boxSizing", !1, s) === "border-box";
    if (
      (u.msFullscreenElement &&
        n.top !== n &&
        t.getClientRects().length &&
        (o = Math.round(t.getBoundingClientRect()[f] * 100)),
      o <= 0 || o == null)
    ) {
      if (
        ((o = p(t, f, s)), (o < 0 || o == null) && (o = t.style[f]), pt.test(o))
      )
        return o;
      h = c && (r.boxSizingReliable() || o === t.style[f]);
      o = parseFloat(o) || 0;
    }
    return o + cf(t, f, e || (c ? "border" : "content"), h, s) + "px";
  }
  ...
  function yo(n, t, u) {
    ...
    n.nodeType === 1 &&
      ...
      b === "inline" &&
        i.css(n, "float") === "none" &&
        (r.inlineBlockNeedsLayout && yt(n.nodeName) !== "inline"
          ? (o.zoom = 1)
  ...
  function h(n, t, r) {
    var f,
      ...
      c = u.props;
    for (po(c, u.opts.specialEasing); s < a; s++)
      if (((f = h.prefilters[s].call(u, n, c, u.opts)), f))
        return (
          i.isFunction(f.stop) &&
  ...
  function fs(n) {
    while (n && n.nodeType === 1) {
      if (us(n) === "none" || n.type === "hidden") return !0;
      n = n.parentNode;
    }
    return !1;
  }
  ...
  i.fn.extend({
    ...
    is: function (n) {
      return !!ri(this, typeof n == "string" && ar.test(n) ? i(n) : n || [], !1)
        .length;
    },
  });
  yr = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/;
    ...
    closest: function (n, t) {
      for (
        var r,
          ...
          o = this.length,
          u = [],
          e = ar.test(n) || typeof n != "string" ? i(n, t || this.context) : 0;
        f < o;
        f++
      )
  ...
  i.Callbacks = function (n) {
    n = typeof n == "string" ? be(n) : i.extend({}, n);
    var e,
      r,
      h,
      f,
  ...
  i.event = {
      ...
      if (a) {
        for (
              ...
              ((h = a.handle =
                function (n) {
                  return typeof i != "undefined" &&
                    ...
                    ? i.event.dispatch.apply(h.elem, arguments)
                    : undefined;
                }),
              (h.elem = n)),
            t = (t || "").match(s) || [""],
          ...
          e) &&
            ...
            o.add &&
              (o.add.call(n, c), c.handler.guid || (c.handler.guid = r.guid)),
    ...
    trigger: function (t, r, f, e) {
      ...
      if (
        ...
        (s.indexOf(".") > -1 && ((v = s.split(".")), (s = v.shift()), v.sort()),
        (a = s.indexOf(":") < 0 && "on" + s),
    ...
    fix: function (n) {
      ...
      for (
        t ||
          (this.fixHooks[r] = t =
            to.test(r) ? this.mouseHooks : no.test(r) ? this.keyHooks : {}),
  ...
  i.removeEvent = u.removeEventListener
    ...
    : function (n, t, i) {
        var r = "on" + t;
        n.detachEvent &&
          (typeof n[r] == "undefined" && (n[r] = null), n.detachEvent(r, i));
      };
  ...
  i.Event.prototype = {
    ...
    stopPropagation: function () {
      var n = this.originalEvent;
      ((this.isPropagationStopped = vt), n && !this.isSimulated) &&
  ...
  var io = / jQuery\d+="(?:null|\d+)"/g,
    ...
    oo = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g,
    so = ou(u),
    yi = so.appendChild(u.createElement("div"));
  i.extend({
    ...
    clone: function (n, t, u) {
      ...
      if (
        (r.html5Clone || i.isXMLDoc(n) || !vu.test("<" + n.nodeName + ">")
          ? (s = n.cloneNode(!0))
          : ((yi.innerHTML = n.outerHTML), yi.removeChild((s = yi.firstChild))),
    ...
    cleanData: function (n, t) {
      for (
        ...
        if ((t || ot(u)) && ((f = u[s]), (e = f && h[f]), e)) {
          if (e.events)
            for (o in e.events)
              v[o] ? i.event.remove(u, o) : i.removeEvent(u, o, e.handle);
          h[f] &&
            (delete h[f],
            a || typeof u.removeAttribute == "undefined"
              ? (u[s] = undefined)
              : u.removeAttribute(s),
            c.push(f));
        }
  ...
  (function () {
    function o() {
      ...
      n.getComputedStyle &&
        ...
        (f = (r || {}).top !== "1%"),
        (a = (r || {}).marginLeft === "2px"),
        (c = (r || { width: "4px" }).width === "4px"),
        (t.style.marginRight = "50%"),
        (h = (r || { marginRight: "4px" }).marginRight === "4px"),
  ...
  var ki = /alpha\([^)]*\)/i,
    ...
    lo = /^(none|table(?!-c[ea]).+)/,
    ao = new RegExp("^(" + ei + ")(.*)$", "i"),
    vo = { position: "absolute", visibility: "hidden", display: "block" },
    ...
    style: function (n, t, u, f) {
      if (n && n.nodeType !== 3 && n.nodeType !== 8 && n.style) {
        ...
        if (
          ...
          return o && "get" in o && (e = o.get(n, !1, f)) !== undefined
            ? e
            : c[t];
      }
    },
  ...
  i.each(["height", "width"], function (n, t) {
    i.cssHooks[t] = {
      get: function (n, r, u) {
        if (r)
          return lo.test(i.css(n, "display")) && n.offsetWidth === 0
            ? wi(n, vo, function () {
                return lf(n, t, u);
              })
            : lf(n, t, u);
        ...
        return hf(
          ...
          f
            ? cf(
                ...
                t,
                f,
                r.boxSizing && i.css(n, "boxSizing", !1, e) === "border-box",
                e
              )
            : 0
        );
  ...
  i.each({ margin: "", padding: "", border: "Width" }, function (n, t) {
    ...
    gu.test(n) || (i.cssHooks[n + t].set = hf);
  });
  i.fn.extend({
    css: function (n, t) {
      return y(
    ...
    stop: function (n, t, r) {
      ...
      return (
        ...
        this.each(function () {
          ...
          else for (t in f) f[t] && f[t].stop && vf.test(t) && u(f[t]);
          for (t = e.length; t--; )
            e[t].elem === this &&
              (n == null || e[t].queue === n) &&
    ...
    val: function (n) {
      ...
      return arguments.length
        ...
        ? ((t = i.valHooks[u.type] || i.valHooks[u.nodeName.toLowerCase()]),
          ...
          ? r
          : ((r = u.value),
            typeof r == "string" ? r.replace(wf, "") : r == null ? "" : r)
        : void 0;
    },
  });
  i.extend({
    valHooks: {
      option: {
        get: function (n) {
          ...
          return t != null ? t : i.trim(i.text(n)).replace(bf, " ");
        },
      },
      select: {
        get: function (n) {
    ...
    attr: function (n, t, r) {
      ...
      if (e !== 3 && e !== 8 && e !== 2) {
        ...
        if (
          ((e === 1 && i.isXMLDoc(n)) ||
            ((t = t.toLowerCase()),
            (f = i.attrHooks[t] || (i.expr.match.bool.test(t) ? kf : ft))),
          r !== undefined)
        ) {
          if (r === null) {
            i.removeAttr(n, t);
    ...
    ajax: function (t, r) {
      ...
      var c,
        ...
        f = {
          ...
          getResponseHeader: function (n) {
            ...
            if (o === 2) {
              if (!y)
                for (y = {}; (t = go.exec(b)); ) y[t[1].toLowerCase()] = t[2];
              t = y[n.toLowerCase()];
            }
      ...
      if (
        ...
        (u.dataTypes = i
          ...
          .match(s) || [""]),
        u.crossDomain == null &&
          ((c = te.exec(u.url.toLowerCase())),
          (u.crossDomain = !!(
            c &&
            (c[1] !== et[1] ||
              c[2] !== et[2] ||
              (c[3] || (c[1] === "http:" ? "80" : "443")) !==
                (et[3] || (et[1] === "http:" ? "80" : "443")))
          ))),
        u.data &&
          u.processData &&
      ...
      if (((a = fe(tr, u, r, f)), a)) {
        if (((f.readyState = 1), v && d.trigger("ajaxSend", [f, u]), o === 2))
          return f;
        u.async &&
          u.timeout > 0 &&
  ...
  var es = /%20/g,
    os = /\[\]$/,
    ee = /\r?\n/g,
    ss = /^(?:submit|button|image|reset|file)$/i,
    hs = /^(?:input|select|textarea|keygen)/i;
      ...
      return this.map(function () {
        ...
        .map(function (n, t) {
          ...
          return r == null
            ...
            : i.isArray(r)
            ? i.map(r, function (n) {
                return { name: t.name, value: n.replace(ee, "\r\n") };
              })
  ...
  return (
    ...
    (i.fn.load = function (n, t, r) {
      if (typeof n != "string" && or) return or.apply(this, arguments);
      var u,
        o,
        s,
        f = this,
    ...
    (i.offset = {
      setOffset: function (n, t, r) {
        ...
        c = i.css(n, "left");
        v =
          (l === "absolute" || l === "fixed") && i.inArray("auto", [s, c]) > -1;
        v
